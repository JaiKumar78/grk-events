    ...
    <>
      ...
      <div className="relative bg-main py-20">
          ...
          <div className="xl:w-1/2">
            ...
            <div className="mt-3">
              <img src={assets.birthday_decor} alt="decor3" className="w-full h-50 rounded-lg object-cover border-mustard border-2" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className='xl:w-1/2'>
          <div className="relative w-fit">
            ...
            <div
              ...
              style={{ backgroundImage: `url(${assets.birthday_card_decor})` }}
            ></div>
      ...
      <div className='mt-20 px-6 md:px-16 lg:px-40 max-w-4/5 mx-auto'>
        ...
        <p claLinksName='base-mustard mt-10'>
